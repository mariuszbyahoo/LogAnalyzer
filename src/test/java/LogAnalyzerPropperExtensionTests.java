...
public class LogAnalyzerPropperExtensionTests {

    private String fileName;

    public LogAnalyzerPropperExtensionTests (String fileName){
    ...
    public static Collection data(){
        ...
        Object [] parameters = new Object[]{"badExtensionFile.iml",
                "badExtensionFile.IML"};
